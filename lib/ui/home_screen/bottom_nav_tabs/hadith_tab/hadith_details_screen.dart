        ...
        child: Column(
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Image.asset("assets/images/sura_left_decoration.png",),
                Text(arguments.hadithTitle,style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.primary),),
                Image.asset("assets/images/sura_right_decoration.png",),
              ],
            ),
            Padding(
              ...
              child: Text(textDirection: TextDirection.rtl,
                ...
                arguments.hadithContent,style: Theme.of(context).textTheme.titleMedium,),
            ),
